<?php session_start(); ?>
<?php
include_once dirname(__FILE__) . '/SigninbackendReciever.php';
?>
<!DOCTYPE html>
                ...
                <div class="formbg-outer">
                    <div class="formbg">
                        <div class="formbg-inner padding-horizontal--48">
                            <span class="padding-bottom--15">Sign in as reciever</span>
                            <form action="" method="post" id="frmLogin">
                                ...
                                <div class="field">
                                    <a class="ssolink" href="SigninHospital.php">Sign in as Hospital</a>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="footer-link padding-top--24">
                        <span>Don't have an account? <a href="SignupReciever.php">Sign up</a></span>
