<?php
include_once dirname(__FILE__) . '/SignupbackendHospital.php';
?>
<!DOCTYPE html>
                ...
                <div class="formbg-outer">
                    <div class="formbg">
                        <div class="formbg-inner padding-horizontal--48">
                            <span class="padding-bottom--15">Create New Hospital Account</span>
                            <form action="" method="post" id="frmLogin">

                                <div class="field padding-bottom--24">
                                    <input type="Name" name="name" placeholder="Hospital Name" required>
                                </div>
                                <div class="field padding-bottom--24">
                        ...
                        <div class="field field padding-bottom--24">
                                    <a class="ssolink" href="SignupReciever.php">Sign up as Reciever</a>
                                </div>
                        </form>
                    </div>
                </div>
                <div class="footer-link padding-top--24">
                    <span>Already have an account? <a href="SigninHospital.php">Sign In</a></span>
